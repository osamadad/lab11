...
public class Post {
    ...
    @Size(min = 5, max = 15, message = "Sorry, the title can't be less than 5 or longer than 15 character, please try again")
    ...
    @NotNull(message = "Sorry, the publish date can't be empty, please try again")
